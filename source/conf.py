...
htmlhelp_basename = u'mPython 帮助文档'
...
latex_documents = [
    (master_doc, 'mPython.tex', u'mPython 编程手册',
     'LabPlus', 'manual'),
]
...
man_pages = [
    (master_doc, u'mPython', u'mPython 编程手册',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mPythondocs', 'mPython docs Documentation',
     author, 'mPythondocs', 'One line description of project.',
     'Miscellaneous'),
]
